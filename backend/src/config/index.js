...
module.exports = {
  ...
  orangeMoney: {
    ...
    clientId: process.env.ORANGE_MONEY_CLIENT_ID || process.env.OM_CLIENT_ID,
    clientSecret: process.env.ORANGE_MONEY_CLIENT_SECRET || process.env.OM_CLIENT_SECRET,
    merchantKey: process.env.ORANGE_MONEY_MERCHANT_KEY || process.env.OM_MERCHANT_KEY,
    webhookSecret: process.env.ORANGE_MONEY_WEBHOOK_SECRET || process.env.OM_WEBHOOK_SECRET,
